...
export default function User(props) {
    ...
    return (
        <>
            ...
            <div className="container-main-user-nl">
            <label className="container-main-user-name">{name}</label>
            <a className="container-main-user-login" href={props.userUrl} rel="noreferrer" target="_blank" >  {login} </a>
            </div>

            <div className="container-main-user-follow">
                <div className="container-main-user-follow-ers">
                    ...
                    <label>{props.followers} followers</label>
                    </div>
                <div className="container-main-user-follow-ing">
                    <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div>{props.following} following</div></div>
            </div>
        </>
    )
}
